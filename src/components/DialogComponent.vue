...
<template>
  <dialog v-if="accountStore.deposit" class="w-full animate__animated animate__slideInLeft bg-white top-20 fixed flex items-center justify-center max-w-sm mx-auto rounded-t-xl z-50">
  ...
  <dialog v-if="accountStore.withdraw" class="w-full animate__animated animate__slideInLeft bg-white bottom-0 fixed flex items-center justify-center max-w-sm mx-auto rounded-t-xl z-50">
    <div class="w-full p-4">
      <div class="flex items-center justify-between border-b border-gray-300 border-dashed mb-3">
